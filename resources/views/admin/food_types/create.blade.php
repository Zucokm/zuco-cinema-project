    ...
    <x-slot name="header">
        <div class="flex items-center gap-4 group">
            ...
            <div>
                ...
                <p class="text-xs font-bold text-orange-500 uppercase tracking-widest mt-0.5">Setup Food Classification</p>
            </div>
        </div>
    </x-slot>
                ...
                <form method="POST" action="{{ route('admin.food-types.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="name" type="text" name="name" required value="{{ old('name') }}" autofocus
                            class="w-full bg-[#0a0a0a] border border-gray-800 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 font-bold transition-colors shadow-inner placeholder-gray-700" placeholder="e.g. Popcorn, Beverages">
                    ...
                    <div class="mb-6 p-6 border border-gray-800 rounded-2xl bg-[#0a0a0a]/50">
                        <label for="imagePath" class="block text-[10px] font-black text-orange-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                            Category Image (Optional)
                        </label>
                        <input type="file" name="imagePath" id="imagePath" accept="image/*"
                            class="w-full text-sm text-gray-400 file:cursor-pointer file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-[10px] file:font-black file:uppercase file:tracking-widest file:bg-orange-500/10 file:text-orange-400 hover:file:bg-orange-500/20 transition-colors" />
                        <x-input-error :messages="$errors->get('imagePath')" class="mt-2 text-red-400 text-xs" />
                        <p class="text-[10px] text-gray-500 font-bold mt-3 uppercase tracking-wider">Recommended: JPG, PNG, WEBP (Max: 2MB)</p>
                    </div>
                    ...
                    <div class="mb-6">
                        <label for="isActive" class="inline-flex items-center cursor-pointer group">
                            <div class="relative">
                                ...
                                <div class="w-11 h-6 bg-gray-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-gray-400 peer-checked:after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-orange-500 border border-gray-700 peer-checked:border-orange-400 shadow-inner"></div>
                            </div>
