    ...
    <div class="min-h-screen w-full flex items-center justify-center relative overflow-hidden px-4 sm:px-6 py-12">
        ...
        <div class="w-full max-w-md bg-[#111]/80 backdrop-blur-xl rounded-[2rem] p-8 md:p-10 border border-gray-800 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative z-10 transform transition-all duration-500 hover:border-gray-700">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-400">Join ZUCO for the ultimate cinema experience</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5" x-data="{ showPassword: false, showConfirmPassword: false }">
                ...
                <button type="submit" class="w-full bg-[#df1873] hover:bg-[#c21463] text-white font-bold py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(223,24,115,0.3)] hover:shadow-[0_0_25px_rgba(223,24,115,0.5)] flex justify-center items-center gap-2 group mt-6">
            ...
            <p class="mt-8 text-center text-sm text-gray-500 font-medium border-t border-gray-800/50 pt-8">
                Already registered? 
                <a href="{{ route('login') }}" class="font-bold text-white hover:text-[#df1873] transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-[#df1873] hover:after:w-full after:transition-all after:duration-300">Sign in here</a>
            </p>
        </div>
    </div>
</x-guest-layout>