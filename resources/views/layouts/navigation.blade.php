...
<nav x-data="{ mobileMenuOpen: false, scrolled: false }" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-[80px] transition-all duration-500" :class="{'h-[70px]': scrolled}">
            ...
            <div class="hidden md:flex space-x-10 items-center justify-center flex-1">
                <a href="{{ route('movies.index') }}" class="relative text-gray-300 font-bold text-sm hover:text-white transition-colors group py-2">
                    Movies
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#df1873] transition-all duration-300 ease-out group-hover:w-full rounded-full shadow-[0_0_8px_rgba(223,24,115,0.8)]"></span>
                </a>
                <a href="{{ route('cinemas.index') }}" class="relative text-gray-300 font-bold text-sm hover:text-white transition-colors group py-2">
                    Cinemas
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#df1873] transition-all duration-300 ease-out group-hover:w-full rounded-full shadow-[0_0_8px_rgba(223,24,115,0.8)]"></span>
                </a>
                <a href="{{ route('contact.index') }}" class="relative text-gray-300 font-bold text-sm hover:text-white transition-colors group py-2">
                    Contact Us
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#df1873] transition-all duration-300 ease-out group-hover:w-full rounded-full shadow-[0_0_8px_rgba(223,24,115,0.8)]"></span>
                </a>
                <a href="{{ route('about') }}" class="relative text-gray-300 font-bold text-sm hover:text-white transition-colors group py-2">
                    About Us
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#df1873] transition-all duration-300 ease-out group-hover:w-full rounded-full shadow-[0_0_8px_rgba(223,24,115,0.8)]"></span>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-6 flex-shrink-0">
                @auth
                    @if(Auth::user()->role === 'admin')
                        <a href="{{ route('admin.pos') }}" class="text-gray-300 hover:text-white font-bold text-sm transition-colors hover:scale-105 transform">POS</a>
                        <a href="{{ route('my-tickets') }}" class="text-gray-300 hover:text-white font-bold text-sm transition-colors hover:scale-105 transform">My Tickets</a>
                        <a href="{{ route('admin.dashboard') }}" class="text-[#df1873] hover:text-[#ff2a8a] font-black tracking-wide text-sm transition-colors hover:scale-105 transform drop-shadow-[0_0_8px_rgba(223,24,115,0.5)]">Dashboard</a>
                    @else
                    ...
                    <div x-data="{ profileOpen: false }" class="relative" @click.away="profileOpen = false">
                        ...
                        <div x-show="profileOpen" 
                             ...
                             class="absolute right-0 mt-3 w-48 bg-[#111]/90 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] py-2 z-50 overflow-hidden" style="display: none;">
    ...
    <div x-show="mobileMenuOpen" 
         ...
         class="md:hidden bg-[#0a0a0a]/95 backdrop-blur-2xl border-b border-gray-800 absolute w-full left-0 shadow-2xl" style="display: none;">
        <div class="px-4 pt-4 pb-6 space-y-2">
            <a href="{{ route('movies.index') }}" class="block text-gray-300 hover:text-white hover:bg-white/5 px-4 py-3 rounded-xl font-bold text-base transition-colors">Movies</a>
            <a href="{{ route('cinemas.index') }}" class="block text-gray-300 hover:text-white hover:bg-white/5 px-4 py-3 rounded-xl font-bold text-base transition-colors">Cinemas</a>
            <a href="{{ route('contact.index') }}" class="block text-gray-300 hover:text-white hover:bg-white/5 px-4 py-3 rounded-xl font-bold text-base transition-colors">Contact Us</a>
            <a href="{{ route('about') }}" class="block text-gray-300 hover:text-white hover:bg-white/5 px-4 py-3 rounded-xl font-bold text-base transition-colors">About Us</a>
...
<nav x-data="{ open: false }" class="bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-[100] transition-all duration-300 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
        ...
        <div class="flex justify-between h-[70px]">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <a href="{{ $dashboardRoute }}" class="relative font-bold text-sm transition-colors py-2 group {{ $isDashboardActive ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                        ...
                        @if($isDashboardActive)
                            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-indigo-500 rounded-full shadow-[0_0_8px_rgba(99,102,241,0.8)]"></span>
                        @else
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-indigo-500 transition-all duration-300 ease-out group-hover:w-full rounded-full"></span>
                        @endif
                    </a>
                    ...
                    <div x-data="{ opsOpen: false }" class="relative" @click.away="opsOpen = false">
                        <button @click="opsOpen = !opsOpen" class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-bold transition-all duration-200" :class="opsOpen ? 'bg-white/10 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5'">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                            <span>Operations</span>
                            <svg :class="{'rotate-180': opsOpen}" class="w-4 h-4 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        ...
                        <div x-show="opsOpen" 
                             ...
                             class="absolute left-0 mt-3 w-56 bg-[#111]/90 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] p-2 z-50" style="display: none;">
                    ...
                    <div x-data="{ sysOpen: false }" class="relative" @click.away="sysOpen = false">
                        <button @click="sysOpen = !sysOpen" class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-bold transition-all duration-200" :class="sysOpen ? 'bg-white/10 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5'">
                            ...
                            <svg :class="{'rotate-180': sysOpen}" class="w-4 h-4 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div x-data="{ adminProfile: false }" class="relative" @click.away="adminProfile = false">
                    <button @click="adminProfile = !adminProfile" class="flex items-center gap-2 bg-[#111] border border-gray-700 hover:border-gray-500 text-white font-bold text-sm px-3 py-1.5 rounded-full transition-all focus:outline-none">
                        ...
                        <svg :class="{'rotate-180': adminProfile}" class="w-4 h-4 text-gray-400 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>

                    <div x-show="adminProfile" 
                         x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2 scale-95" x-transition:enter-end="opacity-100 translate-y-0 scale-100"
                         x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0 scale-100" x-transition:leave-end="opacity-0 translate-y-2 scale-95"
                         class="absolute right-0 mt-3 w-48 bg-[#111]/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] py-2 z-50 overflow-hidden" style="display: none;">
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-gray-300 hover:text-white hover:bg-white/5 transition-colors group">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10 transition-all focus:outline-none">
    ...
    <div x-show="open" 
         x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0"
         x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-4"
         class="sm:hidden bg-[#0a0a0a]/95 backdrop-blur-2xl border-b border-gray-800 shadow-2xl absolute w-full left-0" style="display: none;">
